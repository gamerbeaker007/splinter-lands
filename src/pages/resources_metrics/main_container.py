...
from src.pages.resources_metrics import tab_production, tab_active, tab_region_overview, tab_compare

log = logging.getLogger("Region - main container")


def get_page(filtered_all_data, date_str):
    tab1, tab2, tab3, tab4 = st.tabs(['Active', 'Production', 'Compare', 'Region Production Overview'])
    with tab1:
